...
const pool = new Pool({ connectionString: ENV.DATABASE_URL });git add backend/src/config/env.ts
git commit -m "Add DATABASE_URL env mapping; fix drizzle DB config"
git push
